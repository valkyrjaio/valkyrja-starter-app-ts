...
**application — example app / skeleton** — Valkyrja **TypeScript** port.
...
2. **TypeScript-specific** — https://github.com/valkyrjaio/architecture/blob/master/typescript/AGENTS.md
